...
Here's a method for retiming text from normal to fast ("!!!"), permitted on the IL sheet as part of retiming from RTA or similar. It's generic so applicable to any text. Let's call the run being retimed the **subject** run.
